(function () {
  ...
  const state = {
    ...
    mode: null,       // solo para 'customer': 'challenge' | 'free' — delivery siempre es "challenge" (el ticket)
    mission: null,    // { kind, description, check(cart) } — la meta del modo Challenge de Customer
    category: null,
    cart: { items: [] },
    target: null,
    ticketNumber: null,
